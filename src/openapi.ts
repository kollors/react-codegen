...
export function createOpenapiConfig(options: OpenapiConfigOptions) {
  ...
  return defineConfig({
    openapi: {
      ...
      to: async(context) => {
        ...
        writeFileSync(join(options.filename), componentsStr, 'utf-8');
